;( function( $, window, undefined ) {
    ...
    $(window).load(function() {
        ...
        $("#loader").fadeOut("slow", function(){
            ...
            {
                $('.aos-init').css('visibility', 'visible');

            } else {
                AOS.init({throttleDelay: 10,  disable: 'phone',})
                AOS.refresh();
                AOS.refreshHard();
            }
            ...
            // observer.observe();
            // var allLozadImages = document.querySelector('.lozad');
            //
            // //... trigger the load of a image before it appears on the viewport
            // observer.triggerLoad(allLozadImages);
    ...
    $(document).ready(function($) {
        ...
        var subItem = document.querySelectorAll(".arrow-down");
        ...
        function subMenuToggleHandler(toggle) {
            toggle.addEventListener( "click", function(e) {
                ...
                console.log();
                (this.parentNode.getElementsByClassName('sub-menu')[0].classList.contains("open") === true) ? this.parentNode.getElementsByClassName('sub-menu')[0].classList.remove("open") : this.parentNode.getElementsByClassName('sub-menu')[0].classList.add("open");
                (this.classList.contains("open") === true) ? this.classList.remove("open") : this.classList.add("open");

                // var subMenu = toggle.getElementsByClassName("sub-menu")[0]
        ...
        function attachCalendar(){
            ...
            console.log(new Date().toLocaleString('en-GB', Dateoptions)); // 9/17/2016
        ...
        // Loop on each calendar initialized
            for(var i = 0; i < calendars.length; i++) {
                ...
                calendars[i].on('date:selected', function(){
                    //console.log(date);
            });
            }
        }
